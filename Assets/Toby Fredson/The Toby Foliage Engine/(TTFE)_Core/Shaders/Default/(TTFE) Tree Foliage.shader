	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 appendResult820_g1492 = (float3(0.0 , 0.0 , saturate( v.positionOS.xyz ).z));
				float3 break862_g1492 = v.positionOS.xyz;
				...
				float3 temp_output_573_0_g1492 = ( ( v.positionOS.xyz - float3(0,-1,0) ) / _Radius );
				...
				float2 appendResult810_g1492 = (float2(v.positionOS.xyz.x , v.positionOS.xyz.z));
				float3 temp_output_869_0_g1492 = ( cross( temp_cast_1 , float3( appendResult810_g1492 ,  0.0 ) ) * 0.005 );
				float3 appendResult813_g1492 = (float3(0.0 , v.positionOS.xyz.y , 0.0));
				float3 break845_g1492 = v.positionOS.xyz;
				...
				float dotResult730_g1492 = dot( (v.positionOS.xyz*0.02 + 0.0) , v.positionOS.xyz );
				float CeneterOfMassThickness_Mask734_g1492 = saturate( dotResult730_g1492 );
				float3 appendResult854_g1492 = (float3(v.positionOS.xyz.x , 0.0 , 0.0));
				float3 break857_g1492 = v.positionOS.xyz;
				...
				float3 normalizeResult1560_g1492 = normalize( v.positionOS.xyz );
				...
				float3 worldToObj796_g1492 = mul( GetWorldToObjectMatrix(), float4( v.positionOS.xyz, 1 ) ).xyz;
				...
				float3 normalizeResult581_g1492 = normalize( v.positionOS.xyz );
				...
				float3 worldToObj797_g1492 = mul( GetWorldToObjectMatrix(), float4( v.positionOS.xyz, 1 ) ).xyz;
				...
				float3 normalizeResult647_g1492 = normalize( v.positionOS.xyz );
				...
				float3 worldToObj1376_g1492 = mul( GetWorldToObjectMatrix(), float4( v.positionOS.xyz, 1 ) ).xyz;
				...
				float4 LeafVertexColor_Main1540_g1492 = (( _SwitchVGreenToRGBA )?( v.ase_color ):( temp_cast_12 ));
				float mulTime1349_g1492 = _TimeParameters.x * 0.4;
				float3 worldToObj1443_g1492 = mul( GetWorldToObjectMatrix(), float4( v.tangentOS.xyz, 1 ) ).xyz;
				float2 panner1354_g1492 = ( mulTime1349_g1492 * float2( 1,1 ) + ( worldToObj1443_g1492 * 0.1 ).xy);
				float2 texCoord1355_g1492 = v.texcoord.xy * float2( 0.2,0.2 ) + panner1354_g1492;
				...
				float simplePerlin2D1395_g1492 = snoise( ( ( StrongWindSpeed994_g1492 * _TimeParameters.x ) + ( v.tangentOS.xyz * 1.0 ) ).xy );
				#ifdef _LEAFFLUTTER_ON
				float4 staticSwitch1263_g1492 = ( ( ( ( simpleNoise1430_g1492 * 0.9 ) * float4( float3(-1,-0.5,-1) , 0.0 ) * float4( v.tangentOS.xyz , 0.0 ) * saturate( v.positionOS.xyz.y ) * float4( MotionFlutterConstant1481_g1492 , 0.0 ) * WindMask_LargeC726_g1492 * LeafVertexColor_Main1540_g1492 ) + ( ( float4( worldToObjDir1435_g1492 , 0.0 ) * float4( float3(-1,-1,-1) , 0.0 ) * saturate( v.positionOS.xyz.y ) * LeafVertexColor_Main1540_g1492 * float4( ase_objectScale , 0.0 ) ) * 1 ) + ( ( float4( float3(-1,-1,-1) , 0.0 ) * lerpResult10_g1493 * simpleNoise1455_g1492 * saturate( v.positionOS.xyz.y ) * LeafVertexColor_Main1540_g1492 * float4( v.tangentOS.xyz , 0.0 ) ) * 2 ) + ( ( simplePerlin2D1395_g1492 * 0.11 ) * float4( float3(5.9,5.9,5.9) , 0.0 ) * float4( v.tangentOS.xyz , 0.0 ) * saturate( v.positionOS.xyz.y ) * WindMask_LargeA595_g1492 * LeafVertexColor_Main1540_g1492 ) + ( ( float4( temp_output_1316_0_g1492 , 0.0 ) * saturate( v.positionOS.xyz.y ) * LeafVertexColor_Main1540_g1492 ) * 3 ) ) * _GlobalFlutterIntensity );
				#else
				float4 staticSwitch1263_g1492 = float4( 0,0,0,0 );
				#endif
				float3 worldToObj1580_g1492 = mul( GetWorldToObjectMatrix(), float4( v.positionOS.xyz, 1 ) ).xyz;
				...
				float3 temp_cast_37 = (dotResult504_g1487).xxx;
				float4 appendResult525_g1487 = (float4(break514_g1487.x , ( break514_g1487.y + saturate( ( 1.0 - ( ( distance( float3( 0,0,0 ) , temp_cast_37 ) - 0.2 ) / max( 0.2 , 1E-05 ) ) ) ) ) , break514_g1487.z , 0.0));
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float4 LeafVertexColor_Main1540_g1492 = (( _SwitchVGreenToRGBA )?( v.ase_color ):( temp_cast_12 ));
				float mulTime1349_g1492 = _TimeParameters.x * 0.4;
				float3 worldToObj1443_g1492 = mul( GetWorldToObjectMatrix(), float4( v.ase_tangent.xyz, 1 ) ).xyz;
				float2 panner1354_g1492 = ( mulTime1349_g1492 * float2( 1,1 ) + ( worldToObj1443_g1492 * 0.1 ).xy);
				float2 texCoord1355_g1492 = v.ase_texcoord.xy * float2( 0.2,0.2 ) + panner1354_g1492;
				float3 normalizeResult589_g1492 = normalize( ase_worldPos );
				float mulTime590_g1492 = _TimeParameters.x * 0.2;
				float simplePerlin2D592_g1492 = snoise( ( normalizeResult589_g1492 + mulTime590_g1492 ).xy*0.4 );
				float WindMask_LargeA595_g1492 = ( simplePerlin2D592_g1492 * 1.5 );
				...
				float simpleNoise1455_g1492 = SimpleNoise( ( appendResult1454_g1492 + ( StrongWindSpeed994_g1492 * _TimeParameters.x ) )*4.0 );
				simpleNoise1455_g1492 = simpleNoise1455_g1492*2 - 1;
				float simplePerlin2D1395_g1492 = snoise( ( ( StrongWindSpeed994_g1492 * _TimeParameters.x ) + ( v.ase_tangent.xyz * 1.0 ) ).xy );
				#ifdef _LEAFFLUTTER_ON
				float4 staticSwitch1263_g1492 = ( ( ( ( simpleNoise1430_g1492 * 0.9 ) * float4( float3(-1,-0.5,-1) , 0.0 ) * float4( v.ase_tangent.xyz , 0.0 ) * saturate( v.positionOS.xyz.y ) * float4( MotionFlutterConstant1481_g1492 , 0.0 ) * WindMask_LargeC726_g1492 * LeafVertexColor_Main1540_g1492 ) + ( ( float4( worldToObjDir1435_g1492 , 0.0 ) * float4( float3(-1,-1,-1) , 0.0 ) * saturate( v.positionOS.xyz.y ) * LeafVertexColor_Main1540_g1492 * float4( ase_objectScale , 0.0 ) ) * 1 ) + ( ( float4( float3(-1,-1,-1) , 0.0 ) * lerpResult10_g1493 * simpleNoise1455_g1492 * saturate( v.positionOS.xyz.y ) * LeafVertexColor_Main1540_g1492 * float4( v.ase_tangent.xyz , 0.0 ) ) * 2 ) + ( ( simplePerlin2D1395_g1492 * 0.11 ) * float4( float3(5.9,5.9,5.9) , 0.0 ) * float4( v.ase_tangent.xyz , 0.0 ) * saturate( v.positionOS.xyz.y ) * WindMask_LargeA595_g1492 * LeafVertexColor_Main1540_g1492 ) + ( ( float4( temp_output_1316_0_g1492 , 0.0 ) * saturate( v.positionOS.xyz.y ) * LeafVertexColor_Main1540_g1492 ) * 3 ) ) * _GlobalFlutterIntensity );
				#else
				float4 staticSwitch1263_g1492 = float4( 0,0,0,0 );
				#endif
				float3 worldToObj1580_g1492 = mul( GetWorldToObjectMatrix(), float4( v.positionOS.xyz, 1 ) ).xyz;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 worldToObj1443_g1492 = mul( GetWorldToObjectMatrix(), float4( v.ase_tangent.xyz, 1 ) ).xyz;
				float2 panner1354_g1492 = ( mulTime1349_g1492 * float2( 1,1 ) + ( worldToObj1443_g1492 * 0.1 ).xy);
				float2 texCoord1355_g1492 = v.texcoord0.xy * float2( 0.2,0.2 ) + panner1354_g1492;
				float3 normalizeResult589_g1492 = normalize( ase_worldPos );
				float mulTime590_g1492 = _TimeParameters.x * 0.2;
				float simplePerlin2D592_g1492 = snoise( ( normalizeResult589_g1492 + mulTime590_g1492 ).xy*0.4 );
				float WindMask_LargeA595_g1492 = ( simplePerlin2D592_g1492 * 1.5 );
...
Node;AmplifyShaderEditor.FunctionNode;2897;544,368;Inherit;False;(TTFE) Tree Foliage_Wind System;30;;1492;ccec0b38fced125459cc01da4402fa7a;0;0;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2846;1338.528,120.0737;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;Toby Fredson/The Toby Foliage Engine/(TTFE) Tree Foliage;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;39;Workflow;0;638460488701576305;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;0;638455995459585606;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2847;1338.528,120.0737;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2848;1338.528,120.0737;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2849;1338.528,120.0737;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2853;1338.528,120.0737;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2854;1338.528,120.0737;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=E46F610DEB2309D89D1175A3AB17BCC80999DC31