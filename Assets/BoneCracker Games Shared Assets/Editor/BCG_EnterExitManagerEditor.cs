...
public class BCG_EnterExitManagerEditor : Editor {
    ...
    [MenuItem("GameObject/BoneCracker Games/Shared Assets/Enter-Exit/Edit Enter-Exit Settings", false, -100)]
    ...
    [MenuItem("GameObject/BoneCracker Games/Shared Assets/Enter-Exit/Add Main Enter-Exit Manager To Scene", false)]
    ...
    [MenuItem("GameObject/BoneCracker Games/Shared Assets/Enter-Exit/Add Enter-Exit To Vehicle", false)]
    public static void CreateEnterExitVehicle() {
        ...
        if (Selection.activeGameObject.GetComponentInParent<BCG_EnterExitVehicle>(true))
    ...
    [MenuItem("GameObject/BoneCracker Games/Shared Assets/Enter-Exit/Add Enter-Exit To FPS Player", false)]
    public static void CreateEnterExitPlayer() {
        ...
        if (Selection.activeGameObject.GetComponentInParent<BCG_EnterExitPlayer>(true))
